    ...
    <AppLayout>
       ...
       <Box
          sx={{marginTop:"20px",
             ...
             <Typography varient="h1" component={"div"} sx={{fontSize:"20px",color:"white", marginTop:"30px",marginBottom:"25px"}}>{leagueName}</Typography>
      ...
      overflowY: 'auto'
        ...
        {loading ? (
          ...
          <Grid container spacing={{md:3}} sx={{ display: "flex", justifyContent: "space-around", borderBottom: "1px solid gray", padding: "2px 2px" }}>
            ...
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap sx={{fontSize:"15px"}}>試合</Typography></Grid>
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap sx={{fontSize:"15px"}}>勝</Typography></Grid>
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap sx={{fontSize:"15px"}}>分</Typography></Grid>
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap sx={{fontSize:"15px"}}>負</Typography></Grid>
            <Grid item xs={2}><Typography variant="h6" component={"div"} noWrap sx={{fontSize:"15px"}}>point</Typography></Grid>
        </Grid>
          </Box>
        <Swiper
      ...
      {leagueStandings.map((data) => (
        <SwiperSlide key={data.rank}>
          <Grid container spacing={{md:3}} sx={{ display: "flex", justifyContent: "space-around", alignItems:"center",borderBottom: "1px solid gray", margin: "2px 4px",padding:"2px" }}>
            ...
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap>{data.all.draw}</Typography></Grid>
            <Grid item xs={1}sx={{display: { xs: 'none', md: 'block'}}}><Typography variant="h6" component={"div"} noWrap >{data.all.lose}</Typography></Grid>
            <Grid item xs={2}><Typography variant="h6" component={"div"} noWrap>{data.points}</Typography></Grid>
          </Grid>
        </SwiperSlide>
      ))}
      </Swiper> 
